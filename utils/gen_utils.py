...
def parse_args():
    ...
    ap.add_argument("-embed", type=str, default='bert-large')
...
def parse_args_metafeatures():
    ap = argparse.ArgumentParser()
    ap.add_argument("-dataset_type", type=str, default='essays')
    ap.add_argument("-datafile", type=str, default='meta_features_data/essays_concept_count_final.p')  #这里是关键 这里决定了只能提取2468句 是pickle文件
